...
func TestCoinAgeSerialization(t *testing.T) {
	...
	largeValue, _ := new(big.Int).SetString("773838227146369535791560934284610402621879633620663268547829107348156624601088", 10)
	largeAge, _ := new(big.Int).SetString("713623846352979940529142984724747568191373312", 10)
	cases := []coinAge{
		...
		coinAge{Time: 0, Age: largeAge, Value: largeValue},
	}
